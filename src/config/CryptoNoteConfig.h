...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3f0603;
...
const char     CRYPTONOTE_NAME[]                             = "P1Creations-Network";
...
const char     LATEST_VERSION_URL[]                          = "http://www.p1creations.net/latest";
const std::string LICENSE_URL                                = "https://github.com/p1creations/p1creations/blob/master/LICENSE";
